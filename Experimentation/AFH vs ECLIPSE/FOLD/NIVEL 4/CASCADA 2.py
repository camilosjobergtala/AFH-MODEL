...
__version__ = "cascade_v2.3.1_fixed"
...
DEFAULT_OUTPUT = r"G:\Mi unidad\NEUROCIENCIA\AFH\EXPERIMENTO\FASE 2\SLEEP-EDF\awakening_cascade_v2_baseline180"
...
# FIX: baseline_end_s cambiado de -240 a -180 para garantizar ≥4 ventanas de baseline
ONSET_CONFIG = {
    'baseline_end_s': -180,      # Baseline: t < -3 min (4 ventanas de 30s)
