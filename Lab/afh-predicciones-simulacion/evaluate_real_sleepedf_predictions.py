...
Sleep-EDF ya computados en este repositorio -- a diferencia de
...
existe en el repo son los resultados YA calculados por el autor sobre datos
reales de Sleep-EDF Cassette (153 sujetos, columna `subject_id`), en:

    Lab/AFH vs ECLIPSE/FOLD/NIVEL 3 PAC/nivel3b_v3_optimization/raw_results_full.csv
    Lab/AFH vs ECLIPSE/FOLD/NIVEL 0 FOLD/eclipse_v2/DeltaTFold_SleepEDF_RealData_*.json
...
Lab/, separada del manuscrito segun el README del repo) que resultan
tematicamente analogos a esas predicciones, pero con sus propias hipotesis y
metricas propias -- no la operacionalizacion que el paper mismo reclama como
...
No se encontro en el repo el numero exacto que el paper cita en su Seccion 6.3
(F1=0,031 vs criterio >=0,60; d de Cohen=2,44-2,79, N=153 para PAC delta-gamma)
-- probablemente proviene de un analisis no archivado en este repositorio.
...
REPO_ROOT = HERE.parents[1]  # .../AFH-MODEL
LEGACY_FOLD_DIR = REPO_ROOT / "Lab" / "AFH vs ECLIPSE" / "FOLD"
NIVEL3_DIR = LEGACY_FOLD_DIR / "NIVEL 3 PAC" / "nivel3b_v3_optimization"
DELTAFOLD_DIR = LEGACY_FOLD_DIR / "NIVEL 0 FOLD" / "eclipse_v2"
