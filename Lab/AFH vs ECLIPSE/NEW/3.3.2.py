"""
Multivariate Regression Analysis v2.1
...
def main():
    print("=" * 70)
    print("Multivariate Regression Analysis v2.1")
    print("=" * 70)
...
"""
    ...
    ax.set_title('State-Dependent Coefficient Reconfiguration', fontsize=14, fontweight='bold', pad=20)
